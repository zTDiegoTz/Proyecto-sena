...
export function SimpleSupabaseProvider({ children }) {
  ...
  const tienePermiso = (permiso) => {
    ...
    const permisosPorRol = {
      'super_admin': ['gestionar_usuarios', 'gestionar_surtidores', 'gestionar_ventas', 'ver_reportes', 'configurar_sistema'],
      'administrador': ['gestionar_usuarios', 'gestionar_surtidores', 'gestionar_ventas', 'ver_reportes'],
      'bombero': ['registrar_ventas', 'ver_ventas_propias']
    }
    
    return permisosPorRol[usuarioActual.role]?.includes(permiso) || false
  }
