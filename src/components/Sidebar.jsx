...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      visible: tienePermiso('gestionar_surtidores') || tienePermiso('gestionar_precios') || tienePermiso('todos')
    },
    {
      name: 'Ventas',
      path: '/ventas',
      ...
      visible: tienePermiso('gestionar_ventas') || tienePermiso('registrar_ventas') || tienePermiso('ver_ventas') || usuarioActual?.role === 'bombero'
    },
    {
      name: 'Turnos',
      path: '/turnos',
      ...
      visible: tienePermiso('gestionar_turnos') || tienePermiso('gestionar_turno_propio') || tienePermiso('todos')
    },
    {
      name: 'Inventario',
      path: '/inventario',
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            ...
            <div className="mt-3 text-center">
              <p className="text-xs text-gray-500">
                Sesión activa: {usuarioActual.role?.replace('_', ' ') || 'Usuario'}
              </p>
            </div>
          </div>
        </div>
